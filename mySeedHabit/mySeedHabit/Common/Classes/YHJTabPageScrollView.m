...
//    UIView *rootView = self;
    UIView *rootView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-64)];
    [self addSubview:rootView];
    // Load tabs
    UIView *tabView = [UIView new];
    [rootView addSubview:tabView];
    [tabView mas_makeConstraints:^(MASConstraintMaker *make){
        make.left.equalTo(rootView.mas_left).offset(50);
        make.top.equalTo(rootView.mas_top);
        make.right.equalTo(rootView.mas_right).offset(-50);
...
//    _contentView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-49)];
...
-(void)subloadTabView:(UIView*)tabView{
    ...
    [_indicatorView mas_makeConstraints:^(MASConstraintMaker *make){
        ...
        make.bottom.equalTo(_separatorView.mas_top).offset(0);
